...
** It's worth noting that the exact file format has changed over time, and probably will continue to do so, to reflect changes in experimental protocols and software.  However the broad sparse matrix layout has remained consistent.  You can examples of 10X files generted with previous versions of Cell Ranger at https://support.10xgenomics.com/single-cell-gene-expression/datasets **
